...
def weekdays(lang: str) -> List[str]:
    return list(_WEEKDAYS.get(normalize(lang), _WEEKDAYS["ru"]))


def months_cal(lang: str) -> List[str]:
    return list(_MONTHS_CAL.get(normalize(lang), _MONTHS_CAL["ru"]))


def placeholder_search(lang: str) -> str:
    return t(lang, "placeholder_search")
...
STRINGS: Dict[str, Dict[str, str]] = {
    "welcome": {
        "ru": "Привет! Я AviaBot.\nИщу билеты, слежу за ценой и подсказываю, куда дешевле.\n\nВыберите действие внизу ↓",
        "tg": "Салом! Ман AviaBot.\nЧипта меҷӯям, нархро пайгирӣ мекунам ва мегӯям, куҷо арзонтар аст.\n\nАз поён интихоб кунед ↓",
        "uz": "Salom! Men AviaBot.\nChipta qidiraman, narxni kuzataman va qayer arzonligini aytaman.\n\nPastroqdan tanlang ↓",
        "ky": "Салам! Мен AviaBot.\nБилет издейм, бааны көзөмөлдөйм, кайда арзан экенин айтам.\n\nТөмөндөн тандаңыз ↓",
        "kk": "Сәлем! Мен AviaBot.\nБилет іздеймін, бағаны қадағалаймын, қайда арзан екенін айтамын.\n\nТөменнен таңдаңыз ↓",
        "tk": "Salam! Men AviaBot.\nBilet gözleýärin, bahany yzarlaýaryn we nirede arzanlygyny aýdýaryn.\n\nAşakdan saýlaň ↓",
        "az": "Salam! Mən AviaBot.\nBilet axtarıram, qiyməti izləyirəm və haranın ucuz olduğunu deyirəm.\n\nAşağıdan seçin ↓",
        "be": "Прывітанне! Я AviaBot.\nШукаю квіткі, сачу за цаной і падказваю, куды танней.\n\nАбярыце дзеянне ўнізе ↓",
        "en": "Hi! I’m AviaBot.\nI find flights, watch prices and suggest cheaper destinations.\n\nPick an action below ↓",
    },
    "help": {
        "ru": "Найти билеты — пошаговый поиск.\nКуда улететь — идеи направлений.\nКалендарь цен — лучший день месяца.\nМои алерты — падение цены.\nКабинет — язык, валюта, история.\n\nГород, страну, аэропорт или код (LED) можно вводить как есть.",
        "en": "Find tickets — guided search.\nWhere to fly — destination ideas.\nPrice calendar — best day of the month.\nAlerts — price drops.\nCabinet — language, currency, history.\n\nType a city, country, airport or code (LED).",
        ...
        "ky": "Билет издөө — кадам менен.\nАрзан багыттар — идеялар.\nБаа календары — эң арзан күн.\nЭскертмелер — баа түшүшү.\nКабинет — тил, валюта.",
        "kk": "Билет іздеу — қадамдап.\nАрзан бағыттар — идеялар.\nБаға күнтізбесі — ең арзан күн.\nЕскертулер — баға түсуі.\nКабинет — тіл, валюта.",
        "tk": "Bilet gözle — ädimme-ädim.\nArzan ugurlar — pikirler.\nBaha senenamasy — iň arzan gün.\nDuýduryşlar — baha düşmegi.\nKabinet — dil, walýuta.",
        "az": "Bilet axtar — addım-addım.\nUcuz istiqamətlər — ideyalar.\nQiymət təqvimi — ən ucuz gün.\nXəbərdarlıqlar — qiymət düşməsi.\nKabinet — dil, valyuta.",
        "be": "Знайсці квіткі — крок за крокам.\nКуды паляцець — ідэі.\nКаляндар цэн — найтаннейшы дзень.\nАлерты — падзенне цаны.\nКабінет — мова, валюта.",
    },
    "ask_from": {
    ...
    "choose_from": {
        "ru": "Нажмите аэропорт вылета ↓",
        "tg": "Фурудгоҳи парвозро пахш кунед ↓",
        "uz": "Joʻnash aeroportini bosing ↓",
        "ky": "Учуу аэропортун басыңыз ↓",
        "kk": "Ұшу әуежайын басыңыз ↓",
        "tk": "Uçuş aeroportyny basyň ↓",
        "az": "Uçuş hava limanına toxunun ↓",
        "be": "Націсніце аэрапорт вылету ↓",
        "en": "Tap your departure airport ↓",
    },
    "ask_to": {
    ...
    "choose_to": {
        "ru": "Нажмите аэропорт прилёта ↓",
        "uz": "Kelish aeroportini bosing ↓",
        "tg": "Фурудгоҳи нишастро пахш кунед ↓",
        "en": "Tap your arrival airport ↓",
    },
    "placeholder_search": {
        "ru": "Город, страна, аэропорт или код",
        "uz": "Shahar, mamlakat, aeroport yoki kod",
        "tg": "Шаҳр, кишвар, фурудгоҳ ё код",
        "en": "City, country, airport or code",
    },
    "cal_ow": {
        "ru": "➝  одна", "uz": "➝  bir tomon", "tg": "➝  як самт",
        "en": "➝  one-way",
    },
    "cal_rt": {
        "ru": "⇄  туда-обратно", "uz": "⇄  borish-qaytish", "tg": "⇄  рафтуомад",
        "en": "⇄  round-trip",
    },
    "cal_today": {"ru": "Сегодня", "uz": "Bugun", "tg": "Имрӯз", "en": "Today"},
    "cal_tomorrow": {"ru": "Завтра", "uz": "Ertaga", "tg": "Фардо", "en": "Tomorrow"},
    "cal_plus3": {"ru": "+3 дня", "uz": "+3 kun", "tg": "+3 рӯз", "en": "+3 days"},
    "cal_plus7": {"ru": "+7 дней", "uz": "+7 kun", "tg": "+7 рӯз", "en": "+7 days"},
    "cal_clear": {"ru": "Сбросить", "uz": "Tozalash", "tg": "Тоза", "en": "Clear"},
    "cal_done": {"ru": "Найти билеты", "uz": "Qidirish", "tg": "Ҷустуҷӯ", "en": "Search"},
    "cal_pick": {"ru": "Выберите дату", "uz": "Sanani tanlang", "tg": "Санаро интихоб кунед",
                 "en": "Pick a date"},
    "cal_find": {"ru": "Найти · {d}", "uz": "Qidir · {d}", "tg": "Ҷӯй · {d}", "en": "Search · {d}"},
    "dates_rt_hint": {
        "ru": "Сначала вылет, затем обратную — или сразу «Найти».",
        "uz": "Avval uchish, soʻng qaytish — yoki darhol «Qidirish».",
        "tg": "Аввал парвоз, баъд бозгашт — ё якбора «Ҷустуҷӯ».",
        "en": "Pick outbound, then return — or search right away.",
    },
    "city_not_found": {
    ...
    "btn_new_search": {"ru": "Новый поиск", "uz": "Yangi qidiruv", "tg": "Ҷустуҷӯи нав",
                       "en": "New search"},
    "flt_direct": {"ru": "Прямые", "uz": "Toʻgʻri", "tg": "Мустақим", "en": "Direct"},
    "flt_connect": {"ru": "С пересадкой", "uz": "Transferli", "tg": "Бо истгоҳ",
                    "ky": "Отуруу менен", "kk": "Ауысып", "tk": "Geçişli",
                    "az": "Köçürməli", "be": "З перасадкай", "en": "With stops"},
    "flt_bag": {"ru": "С багажом", "uz": "Bagaj bilan", "tg": "Бо бор", "en": "With baggage"},
    "flt_nobag": {"ru": "Без багажа", "uz": "Bagajsiz", "tg": "Бе бор",
                  "ky": "Жүксүз", "kk": "Жүксіз", "tk": "Ýüksüz",
                  "az": "Bağajsız", "be": "Без багажу", "en": "No baggage"},
    ...
    "kb_discover": {"ru": "🌍 Куда улететь", "uz": "🌍 Arzon yoʻnalishlar",
                    "tg": "🌍 Сафарҳои арзон", "en": "🌍 Where to fly"},
    ...
    "cancel": {"ru": "Отменил. Нажмите «Найти билеты», чтобы начать заново.",
               "uz": "Bekor qilindi. Qaytadan boshlash uchun «Chipta qidirish».",
               "tg": "Бекор шуд. Барои аз нав оғоз «Ҷустуҷӯи чипта».",
               "en": "Cancelled. Tap Find tickets to start again."},
    ...
    "in_flight": {"ru": "в пути {t}", "uz": "yoʻlda {t}", "tg": "дар роҳ {t}", "en": "{t} in flight"},
}
